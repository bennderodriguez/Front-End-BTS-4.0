                            ...
                            <form role="form" id="contactForm" data-toggle="validator" class="shake" autocomplete="off">
                                <fieldset>
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Número de cliente" id="cliente_vida" name="cliente_vida" type="number" maxlength="9" min="1" autofocus required data-error="Por favor ingrese el núemro de cliente">
                                        <div class="help-block with-errors text-danger"></div>
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Password" id="pass_cv" name="pass_cv" type="password" required data-error="Por favor ingrese el password">
                                        <div class="help-block with-errors text-danger"></div>
                                    </div>
